...
RUN apt-get update && \
    ...
    curl -sfL https://raw.githubusercontent.com/tokuhirom/Perl-Build/e56e4e44816cb1f9912bf560cc8b86bff609da68/perl-build | perl - $PERL_VERSION /opt/perl-$PERL_VERSION/ -Duseshrplib -j "$(nproc)" && \
